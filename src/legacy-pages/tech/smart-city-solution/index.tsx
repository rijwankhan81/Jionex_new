...
import { smartCityCore } from "../../../constants/tech/smartCitySolution";
...
export default function Solutions({ ...props }) {
  ...
  return (
    <>
      <Head>
        <title>Smart City Solutions | Jionex</title>
        <meta
          name="description"
      ...
      <main className={`${styles.main} ${styles.smartSolution}`}>
        <section className={styles.banner}>
          <Container>
            <ul className={styles.breadcrumb}>
              ...
              <li>
                <Link href="#">{t("Smart City Solutions")}</Link>
              </li>
            </ul>
            <div className={styles.content}>
              <h1>
                {t("Enabling Intelligent, Sustainable Urban Transformation")}
              </h1>
              <p>
                {t(
                  "Enabling Intelligent, Sustainable Urban Transformation Des"
                )}
              </p>
            </div>
          </Container>
          ...
          <Container>
            <div className={styles.wrapper}>
              <div className={styles.btnWrapper}>
                <Link href="#">{t("Consult With Our Team")}</Link>
              </div>
            </div>
          </Container>
        </section>
        ...
        <section className={styles.skills}>
          <Container>
            <div className={styles.head}>
              <h2>{t("Core Capabilities & Tools")}</h2>
            </div>
            <div className={styles.wrapper}>
              {smartCityCore.map((tech, index) => (
